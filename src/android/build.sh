...
cp $path/jniLibs/x86/libplugin.$TARGET_NAME.so ${dst_dir}/jniLibs/x86/libplugin.$TARGET_NAME.so
cp $path/jniLibs/x86_64/libplugin.$TARGET_NAME.so ${dst_dir}/jniLibs/x86_64/libplugin.$TARGET_NAME.so
